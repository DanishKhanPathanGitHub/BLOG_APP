...
urlpatterns = [
    ...
    path("search/search<str:default_sort_by>", views.search, name="search_page"),
    ...
    path("account/registration", views.registration, name="registration_page"),
    path("post_blog/<int:slug>", views.post_blog, name="post_blog"),
